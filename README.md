...
4. Time the entry with the first of CISD / Order Block / Breaker Block / Golden Ratio retracement to be
   touched (priority order is configurable).
...
| `entry_priority` | CISD, ORDER_BLOCK, BREAKER_BLOCK, GOLDEN_RATIO | Order entries are checked in |
